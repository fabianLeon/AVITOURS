...
Class daoReserva {
    ...
    function insertSillaReserva($k_reserva, $k_silla){
        $tabla = "avitour.detalle_silla";
        $campos = array("k_reserva","k_silla");
        $this->database->insertarRegistro($tabla, $campos, array($k_reserva,"'$k_silla'"));
    }
    ...
    function insertPasajeroReserva($k_reserva, $k_pasajero){
        $tabla = "avitour.detalle_pasajero";
        $campos = array("k_reserva","k_pasajero");
        $this->database->insertarRegistro($tabla, $campos, array($k_reserva,$k_pasajero));
    }
